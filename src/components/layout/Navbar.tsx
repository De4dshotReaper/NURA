    ...
    <header className="sticky top-0 z-30 bg-nuraSurface/90 backdrop-blur-md border-b border-nuraBorder px-6 h-16 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <span className="ml-2 text-xs font-medium px-2 py-0.5 rounded-full bg-blue-50 text-primary border border-blue-200/50">Patient Companion</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 pl-2 border-l border-nuraBorder">
          ...
          <div className="hidden md:block text-left">
            ...
            <div className="text-[10px] text-nuraTextSecondary">Patient Profile</div>
          </div>
        </div>
      </div>
    </header>
